...
export default async function MisFavoritosPage() {
  ...
  return (
    <div className="space-y-8">
      <header>
        <p className="eyebrow text-clay-deep">{t.space.favorites.eyebrow}</p>
      ...
      {favorites.length === 0 ? (
        <EmptyState
          ...
          action={
            <ButtonLink href="/disenos" tone="clay" className="mt-2">
                  ...
                  <div className="mt-4 flex gap-2">
                    ...
                    <form action={toggleFavoriteAction}>
                      ...
                      <button
                        ...
                        className="rounded-full border border-line px-3.5 py-2 text-sm text-muted transition-colors hover:border-clay/50 hover:text-clay-deep"
                      >
                        ♥
                      </button>
                    </form>
