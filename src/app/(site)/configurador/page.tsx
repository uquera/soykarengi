  ...
  return (
    <div className="shell grid gap-14 py-16 lg:grid-cols-[1fr_19rem] lg:items-start">
      <div className="min-w-0">
        <Eyebrow className="text-clay-deep">{t.configurator.eyebrow}</Eyebrow>
          ...
          {session ? (
            ...
            <div className="card-soft px-8 py-12 text-center">
              ...
              <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
                <ButtonLink href="/registro?next=/configurador" tone="clay">
          ...
          <ol className="mt-4 space-y-3 text-sm leading-relaxed text-ink-soft">
            {t.configurator.afterSteps.map((s, i) => (
              <li key={s} className="flex gap-3">
                <span className="grid h-5 w-5 shrink-0 place-items-center rounded-full bg-clay-soft text-[0.625rem] font-semibold text-clay-deep">
                  {i + 1}
                </span>
                {s}
              </li>
